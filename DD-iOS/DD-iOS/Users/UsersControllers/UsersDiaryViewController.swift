...
class UsersDiaryViewController: UIViewController {
    ...
    // TableView 설정
    extension UsersDiaryViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    // Date Picker 설정
    extension UsersDiaryViewController: UIPickerViewDelegate, UIPickerViewDataSource {
